...
export interface EnvironmentsApi {
   ...
   */
  createEnvironment(collectionId: string, name: string, description?: string): Environment
   ...
   */
  updateEnvironment(collectionId: string, id: string, update: Partial<Environment>): void
   ...
   */
  setActiveEnvironment(collectionId: string, environmentId: string | undefined): void
   ...
   * @param variable
   */
  addEnvironmentVariable(collectionId: string, environmentId: string, variable: Partial<EnvironmentVariable>): void
   ...
   * @param variableId
   */
  deleteEnvironmentVariable(collectionId: string, environmentId: string, variableId: string): void
}
