      ...
      <AlertDialogContent data-test-id="delete-dialog">
        ...
        <AlertDialogFooter>
          <AlertDialogCancel asChild>
            <Button variant="ghost" size="sm" data-test-id="delete-dialog:cancel-button">
              No
            </Button>
          </AlertDialogCancel>
          <AlertDialogAction asChild>
            <Button variant="destructive" size="sm" onClick={handleSubmit} data-test-id="delete-dialog:confirm-button">
              Yes
            </Button>
          </AlertDialogAction>
        </AlertDialogFooter>
