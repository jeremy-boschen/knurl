    ...
    <div className="space-y-2">
      <div className="flex items-center justify-between">
        ...
        <Button
          ...
          data-test-id="environment-list:add-button"
        >
...
function EnvironmentCard({
  ...
  return (
    <Clickable
      ...
      data-test-id={`environment-list:item:${environment.id}`}
    >
      <div className="flex items-start justify-between gap-2 p-2">
        ...
        <div className="flex flex-shrink-0 items-center gap-1.5">
          <Button
            ...
            data-test-id={`environment-list:duplicate-button:${environment.id}`}
          >
          ...
          <Button
            ...
            data-test-id={`environment-list:delete-button:${environment.id}`}
          >
