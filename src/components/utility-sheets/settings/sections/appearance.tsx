  ...
  return (
    <div className="flex-1 min-h-0 overflow-y-auto space-y-6 p-1">
      ...
      >
        ...
        >
          <SelectTrigger className="w-40 text-sm" data-test-id="appearance:font-size-trigger">
            <SelectValue />
          </SelectTrigger>
          <SelectContent>
      ...
      <SettingRow label="Syntax Highlighting" description="Enable syntax highlighting in editors" className="gap-2">
        <Switch
          ...
          data-test-id="appearance:auto-highlight-switch"
        />
      </SettingRow>
      ...
      <SettingRow label="Color Scheme" description="Change the application color scheme." className="gap-2">
        <Select value={settingsState.appearance.theme} onValueChange={(v) => settingsApi().setTheme(v as Theme)}>
          <SelectTrigger className="w-40 text-sm" data-test-id="appearance:color-scheme-trigger">
            <SelectValue />
          </SelectTrigger>
          <SelectContent>
            ...
            return (
              ...
              >
                <RadioGroupItem
                  ...
                  id={id}
                  className="mt-0.5"
                  data-test-id={`appearance:theme-source-${value}`}
                />
      ...
      >
        <div aria-disabled={!isCustomSource} className={cn("space-y-1", !isCustomSource && "opacity-60")}>
          <Input
            ...
            data-test-id="appearance:custom-url-input"
            endAddon={
              <Button
                type="button"
                variant="ghost"
                ...
                data-test-id="appearance:custom-url-fetch-button"
              >
      ...
      >
        <div className="flex flex-wrap gap-2">
          <Button
            ...
            data-test-id="appearance:edit-theme-button"
          >
          ...
          <Button
            ...
            data-test-id="appearance:reset-theme-button"
          >
      ...
      <AlertDialog open={isFetchConfirmOpen} onOpenChange={setIsFetchConfirmOpen}>
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction
              onClick={fetchThemeFromUrl}
              disabled={fetchCustomTheme.pending}
              data-test-id="appearance:fetch-confirm-apply"
            >
              Fetch and Apply
            </AlertDialogAction>
          </AlertDialogFooter>
