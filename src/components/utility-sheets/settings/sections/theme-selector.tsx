  ...
  return (
    ...
    >
      ...
      <Input
        ...
        className="w-full"
        disabled={disabled}
        data-test-id="theme-selector:registry-url-input"
        endAddon={
          <Button
            type="button"
            variant="ghost"
            ...
            data-test-id="theme-selector:fetch-button"
          >
      ...
      >
        <PopoverTrigger asChild>
          <Button
            ...
            disabled={disabled}
            data-test-id="theme-selector:combobox-trigger"
          >
        ...
        <PopoverContent className="w-[24rem] p-0" side="bottom">
          <Command>
            <CommandInput placeholder="Search themes..." data-test-id="theme-selector:search-input" />
      ...
      <div className="flex items-center gap-0">
        <Button
          ...
          data-test-id="theme-selector:prev-button"
        >
        ...
        <Button
          ...
          title="Next theme"
          data-test-id="theme-selector:next-button"
        >
