        ...
        <header className="flex items-center justify-between px-3 py-2 border-b gap-2">
          <LabeledField label="Requests" placement="after">
            <Checkbox
              ...
              onCheckedChange={(c) => onToggleAllRequests(c === true)}
              data-test-id="import-preview:requests-master-checkbox"
            />
          </LabeledField>
          <Input
            name="import-filter"
            ...
            placeholder="Filter..."
            className="ml-2"
            data-test-id="import-preview:filter-input"
            endAddon={
              <Button
                variant="ghost"
                size="sm"
                ...
                data-test-id="import-preview:filter-clear-button"
              >
              ...
              <li key={r.id}>
                <div className="grid grid-cols-[auto_0.4fr_1fr_minmax(0,1fr)] items-center gap-2 p-2 rounded hover:bg-muted/50 focus-within:bg-muted/60 cursor-pointer min-w-0">
                  <Checkbox
                    ...
                    data-test-id={`import-preview:request-checkbox:${r.id}`}
                  />
        ...
        <header className="flex items-center justify-between px-3 py-2 border-b gap-2">
          <LabeledField label="Environments">
            <Checkbox
              ...
              data-test-id="import-preview:environments-master-checkbox"
            />
          </LabeledField>
        </header>
        <div className="flex-1 min-h-0 overflow-auto p-1">
              ...
              <li key={e.id}>
                <div className="flex items-center gap-2 p-2 rounded hover:bg-muted/50 focus-within:bg-muted/60 cursor-pointer min-w-0">
                  <Checkbox
                    ...
                    data-test-id={`import-preview:environment-checkbox:${e.id}`}
                  />
