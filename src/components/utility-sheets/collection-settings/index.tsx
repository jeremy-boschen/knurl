...
export default function CollectionSettingsSheet({ collectionId, tab = "environments", selectedEnvironmentId }: Props) {
  ...
  return (
    <div className="flex h-full min-h-0 flex-col overflow-hidden" data-test-id="collection-settings:sheet">
      ...
      <div className="flex flex-col overflow-hidden">
        <nav className="flex flex-wrap gap-2 border-b px-6 py-4" aria-label="Collection settings sections">
          <Button
            ...
            size="sm"
            data-test-id="collection-settings:environments-tab-button"
          >
          ...
          <Button
            ...
            size="sm"
            data-test-id="collection-settings:auth-tab-button"
          >
