...
function RequestOptionsPanelComponent({ tabId }: RequestOptionsPanelProps) {
  ...
  return (
    <div className="h-full min-h-0 overflow-y-auto bg-background p-4 text-sm" data-test-id="request-options-panel">
          ...
          <OptionField label="Disable SSL">
            {(id) => (
              <Switch
                ...
                data-test-id="request-options-panel:disable-ssl-switch"
              />
            )}
          </OptionField>
          ...
          <OptionField label="Max Redirects">
            {(id) => (
              <Input
                ...
                data-test-id="request-options-panel:max-redirects-input"
              />
            )}
          </OptionField>
        </div>
          ...
          <OptionField label="HTTP Version">
            {(id) => (
              <RadioGroup
                ...
                data-test-id="request-options-panel:http-version-radiogroup"
              >
          ...
          <OptionField label="User Agent">
            {(id) => (
              <Input
                ...
                data-test-id="request-options-panel:user-agent-input"
              />
            )}
          </OptionField>
          ...
          <OptionField label="DNS Override">
            {(id) => (
              <Input
                ...
                data-test-id="request-options-panel:dns-override-input"
              />
            )}
          </OptionField>
        </div>
        ...
        <div className="grid grid-cols-[8rem_1fr] items-start gap-4">
          ...
          <div className="space-y-2">
            <RadioGroup
              ...
              className="flex items-center gap-4"
              data-test-id="request-options-panel:ca-bundle-radiogroup"
            >
              <div className="flex items-center space-x-2">
            ...
            {caBundleSource === "path" ? (
              <Input
                ...
                data-test-id="request-options-panel:ca-path-input"
                endAddon={
                  <Button
                    size="sm"
                    variant="outline"
