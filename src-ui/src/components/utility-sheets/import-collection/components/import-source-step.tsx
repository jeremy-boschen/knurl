    ...
    <div className="row-start-2 flex items-center justify-start pb-3 gap-4 flex-wrap">
      <LabeledField label="Data Source">
        <div className="flex gap-2">
          <Button variant="outline" onClick={onChooseFile} data-test-id="import-source:choose-file-button">
            <UploadIcon className="h-4 w-4 mr-2" />
            Choose File
          </Button>
          <Button variant="outline" onClick={onPaste} data-test-id="import-source:paste-button">
        ...
        <LabeledField label="Group by tags" placement="after">
          <div className="flex items-center gap-2">
            <Switch
              ...
              data-test-id="import-source:group-tags-switch"
            />
