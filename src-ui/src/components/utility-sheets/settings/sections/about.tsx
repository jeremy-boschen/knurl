    ...
    <div className="flex-1 min-h-0 overflow-y-auto space-y-6 p-1">
      ...
      >
        <Button variant="outline" size="sm" asChild>
          <a
            href="https://github.com/jeremy-boschen/knurl"
            target="_blank"
            rel="noopener noreferrer"
            data-test-id="settings-about:repository-link"
          >
        ...
        <div className="flex gap-2 justify-end">
          <Button variant="outline" size="sm" asChild>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              data-test-id="settings-about:license-link"
            >
              License
            </a>
          </Button>
          <Button variant="outline" size="sm" asChild>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              data-test-id="settings-about:third-party-link"
            >
              Third‑Party Notices
            </a>
          </Button>
