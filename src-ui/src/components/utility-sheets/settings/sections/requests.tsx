    ...
    <div className="flex-1 min-h-0 overflow-y-auto space-y-6 p-1">
      <SettingRow label="Request timeout" description="Maximum time to wait for responses (seconds)">
        <Input
          ...
          data-test-id="settings-requests:timeout-input"
        />
      </SettingRow>
      ...
      >
        <Input
          ...
          data-test-id="settings-requests:max-redirects-input"
        />
      </SettingRow>
      ...
      <SettingRow label="SSL certificate verification" description="Verify SSL certificates for HTTPS requests">
        <Switch
          ...
          data-test-id="settings-requests:ssl-switch"
        />
      </SettingRow>
      ...
      >
        <div className="flex">
          <Input
            ...
            data-test-id="settings-requests:proxy-input"
          />
        </div>
      </SettingRow>
      ...
      >
        <Input
          ...
          data-test-id="settings-requests:preview-limit-input"
        />
      </SettingRow>
    </div>
  )
