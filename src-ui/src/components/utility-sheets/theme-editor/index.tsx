  ...
  return (
    <div className="flex h-full min-h-0 flex-col overflow-hidden">
      ...
      <SheetFooter className="border-t px-6 py-4 flex-row justify-end gap-2">
        <Button variant="outline" onClick={handleResetTheme} data-test-id="theme-editor:reset-button">
          Reset to Default
        </Button>
        <Button variant="default" onClick={handleApplyTheme} data-test-id="theme-editor:apply-button">
          Apply
        </Button>
      </SheetFooter>
    </div>
