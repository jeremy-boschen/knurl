...
export function EnvironmentEditor({ collectionId, environmentId, action: _action }: Props) {
  ...
  function addVariable() {
    // Fire & Forget
    getEnvironmentsApi().addEnvironmentVariable(collection.id, environment.id, {})
  }

  function updateVariable(variableId: string, update: Partial<EnvironmentVariable>) {
    getEnvironmentsApi().updateEnvironmentVariable(collection.id, environment.id, variableId, update)
  }

  function removeVariable(variableId: string) {
    getEnvironmentsApi().deleteEnvironmentVariable(collection.id, environment.id, variableId)
  }
        ...
        <div className="grid grid-cols-1 gap-3">
          <div className="grid grid-cols-[8rem_1fr] items-center gap-3">
            ...
            <Input
              ...
              data-test-id="environment-editor:name-input"
            />
          </div>
          ...
          <div className="grid grid-cols-[8rem_1fr] items-center gap-3">
            ...
            <Input
              ...
              data-test-id="environment-editor:description-input"
            />
          </div>
        </div>
      </div>
      <div className="flex min-h-0 flex-1 flex-col space-y-2">
        <div className="flex items-center justify-start gap-2">
          ...
          <Button
            ...
            data-test-id="environment-editor:add-variable-button"
          >
            ...
            <div key={variable.id} className="grid grid-cols-[2fr_3fr_auto_auto] items-center gap-2 py-0 first:pt-0">
              <div>
                <Input
                  ...
                  className="font-mono"
                  data-test-id={`environment-editor:variable-name-input:${variable.id}`}
                />
              </div>
              <div>
                <Input
                  ...
                  className="font-mono"
                  data-test-id={`environment-editor:variable-value-input:${variable.id}`}
                />
              </div>
              <div>
                <Toggle
                  ...
                  data-test-id={`environment-editor:variable-secure-toggle:${variable.id}`}
                >
              ...
              <div>
                <Button
                  ...
                  data-test-id={`environment-editor:variable-delete-button:${variable.id}`}
                >
