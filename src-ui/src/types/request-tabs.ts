...
export interface RequestTabsApi {
  ...
  loadTab(collectionId: string, requestId: string): Promise<RequestState>

  createRequestTab(collectionId?: string, request?: Partial<RequestState>): void
  ...
  saveNewTab(tabId: string, collectionId: string, name: string, description?: string): void
