...
1. Go to https://github.com/jeremy-boschen/react-panels/security/advisories/new
2. Click "Report a vulnerability"
3. Fill out the form with details about the vulnerability

You can also email security concerns to: (add your email if you want)
...
When using @jeremy-boschen/react-panels:
...
- We will publicly disclose vulnerabilities after patches are released
- Security advisories will be published on GitHub

Thank you for helping keep @jeremy-boschen/react-panels and its users safe!
